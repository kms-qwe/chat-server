...
type ChatV1Client interface {
	...
	SendMassage(ctx context.Context, in *SendMassageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *chatV1Client) SendMassage(ctx context.Context, in *SendMassageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ChatV1/SendMassage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatV1Server interface {
	...
	SendMassage(context.Context, *SendMassageRequest) (*emptypb.Empty, error)
...
func (UnimplementedChatV1Server) SendMassage(context.Context, *SendMassageRequest) (*emptypb.Empty, error) {
...
func _ChatV1_SendMassage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendMassageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatV1Server).SendMassage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ChatV1/SendMassage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatV1Server).SendMassage(ctx, req.(*SendMassageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatV1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ChatV1_SendMassage_Handler,
		},
	},
